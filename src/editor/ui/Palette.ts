...
export type Tool = 'select' | 'mass' | 'anchor' | 'spring' | 'charge-pos' | 'charge-neg' | 'atom' | 'quark' | 'electron' | 'erase';
...
const TOOLS: ToolDef[] = [
  ...
  { tool: 'quark', icon: '◴', labelEn: 'Quark', labelIt: 'Quark' },
  { tool: 'electron', icon: '☁', labelEn: 'Electron', labelIt: 'Elettrone' },
